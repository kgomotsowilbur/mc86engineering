            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 items-center">
              ...
              <ParallaxFade>
                ...
                <h2 className="text-3xl font-bold text-foreground mb-5 leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Built to Last</span>
                </h2>
        ...
        <section className="py-16 bg-primary overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
              {stats.map((stat, i) => (
                <ParallaxScale key={stat.label}>
                  <div className="text-center">
                    <ParallaxFloat speed={0.06 + i * 0.02}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((value, index) => (
                <ParallaxScale key={value.title}>
                  {/* Each card floats at a slightly different speed for a staggered feel */}
                  <ParallaxFloat speed={0.05 + index * 0.03}>
